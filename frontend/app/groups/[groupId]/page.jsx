...
export default function GroupDetailPage() {
  ...
  const handleCopyCode = () => {
    const inviteLink = `${window.location.origin}/invite-preview?code=${group.inviteCode}`;
  ...
  if (loading) {
    return (
      <div style={{ color: '#f5c518', padding: '40px' }}>
        🐝 Loading...
      </div>
    );
  }
      ...
      >
        ...
        >
          ...
          >
            ...
            <Link
              href={`/invite-preview?code=${group?.inviteCode}`}
            >
              <button
                className="btn-outline"
                style={{ fontSize: '13px' }}
        ...
        {tabs.map(t => (
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              background:
                activeTab === t.key ? '#f5c518' : '#222',
              color:
                activeTab === t.key ? '#000' : '#a0a0a0',
              border: 'none',
              cursor: 'pointer',
              transition: 'all 0.2s',
            }}
